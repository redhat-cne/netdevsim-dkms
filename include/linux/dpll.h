...
/*
 * DPLL kAPI used by this DKMS tree.
 *
 * On kernels < 7.0, defer to the host linux/dpll.h (6.8 / 6.9 / 6.17
 * signatures already match our 6.9.5 sources via dkms_compat.h).
 *
 * Linux 7.0 added a dpll_tracker * argument to dpll_device_get/put and
 * dpll_pin_get/put, and exported __dpll_*_change_ntf from the in-tree
 * header.  Those collide with nsim_ symbol renaming and with our 6.9.5
 * dpll_core.c / dpll_netlink.c.  nsim_dpll implements the 6.9.5 kAPI, so
 * on >= 7.0 we compile against that snapshot instead of the host header.
 */

#ifndef _NSIM_DKMS_LINUX_DPLL_H_
#define _NSIM_DKMS_LINUX_DPLL_H_

#include <linux/version.h>

#if LINUX_VERSION_CODE < KERNEL_VERSION(7, 0, 0)
#include_next <linux/dpll.h>
#else
 ...
 *
 * Snapshot of include/linux/dpll.h from Linux 6.9.5.
 */
...
#endif /* _NSIM_DKMS_LINUX_DPLL_H_ */
